  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
        ...
        {/* Contenido de texto */}
        <div className="text-centerlg:text-left flex flex-col">
          {/* Subtítulo superior */}
          ...
          {/* Primer párrafo */}
          <p className="mb-6 max-w-lg text-left text-lg leading-[30px] text-[#6D6D6D]">
          ...
          {/* Segundo párrafo */}
          <p className="max-w-lg text-left text-lg leading-[30px] text-[#6D6D6D]">
