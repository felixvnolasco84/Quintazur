...
export default function HomeAboutSection() {
  return (
    <section id="nosotros" className="mx-auto grid max-w-7xl gap-36 px-4 py-16 md:px-12 md:py-24">
      <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
        ...
        <div className="flex flex-col text-left">
          ...
          <h2 className="mb-8 text-3xl font-light text-blue-800 md:text-4xl lg:text-5xl">
            La tranquilidad{" "}
          ...
          {/* Primer párrafo */}
          <p className="mb-6 max-w-md leading-relaxed text-[#6D6D6D]">
          ...
          {/* Segundo párrafo */}
          <p className="max-w-md leading-relaxed text-[#6D6D6D]">
      ...
      <div className="grid items-center justify-center gap-8">
        <p className="max-w-3xl text-lg font-normal leading-relaxed text-[#6D6D6D] lg:text-2xl">
