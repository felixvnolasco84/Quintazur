import HandHeroImage from "@/assets/img/bg/HeroBackgroundImage.png";
import { NavLink } from "react-router";
import { Button } from "../ui/button";

export default function HomeAboutSection() {
  return (
    <section className="mx-auto grid max-w-7xl gap-36 px-4 py-16 md:px-12 md:py-24">
      <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
        ...
        <div className="flex flex-col text-left">
          ...
          <h2 className="mb-8 text-3xl font-normal text-blue-800 md:text-4xl lg:text-5xl">
            La tranquilidad{" "}
            <span className="font-light italic text-blue-700">
              de
              <br className="hidden md:block" /> sentirte acompañado.
            </span>
          </h2>

          {/* Primer párrafo */}
          <p className="mb-6 leading-relaxed text-[#6D6D6D]">
          ...
          {/* Segundo párrafo */}
          <p className="leading-relaxed text-[#6D6D6D]">
      ...
      <div className="grid items-center justify-center gap-8">
        <p className="max-w-3xl text-lg leading-relaxed text-[#6D6D6D] lg:text-2xl">
        ...
        <NavLink to="/#contacto">
          <Button className="mt-8 h-10 rounded-full bg-[#0033A1] py-3 text-sm font-medium uppercase tracking-wider text-white transition-colors duration-300 hover:bg-blue-800">
            Quiero saber más
          </Button>
        </NavLink>
      </div>
